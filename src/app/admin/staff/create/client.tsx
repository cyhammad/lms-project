...
import { createStaff } from '@/actions/staff'; // Import server action
...
export default function CreateStaffClient({ schoolId }: CreateStaffClientProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const staffData = {
        ...
        experience: formData.experience, // passed as string, server action handles conversion
        monthlySalary: formData.monthlySalary, // passed as string, server action handles conversion
      ...
      if (result.success) {
        ...
        showError(result.error || 'Failed to create staff member');
      }
    } catch (error) {
      console.error('Error creating staff member:', error);
      showError('Failed to create staff member. Please try again.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">Register a new staff member in your school</p>
      </div>
          ...
          <div className="lg:col-span-1">
            ...
            <Card className="bg-gradient-to-br from-green-50 to-slate-50 border-green-200 mt-6">
              <CardHeader>
                ...
                <CardDescription>Create login credentials for the staff member</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1.5">Optional: Leave blank if not needed</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="+92xxxxxxxxxxx or 03xxxxxxxxx"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        setFormData({ ...formData, staffType: e.target.value as StaffType, subjects: e.target.value === 'TEACHER' ? formData.subjects : formData.subjects });
