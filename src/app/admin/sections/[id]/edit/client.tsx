...
export default function EditSectionClient({ section, classes }: EditSectionClientProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await updateSection(section.id, submitData);
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Update the details for this section</CardDescription>
        </CardHeader>
        <CardContent>
